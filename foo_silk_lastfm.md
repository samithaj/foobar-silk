...
#### Releases ####
```
[2011-XX-XX] foo_silk lastfm 2.0      | TBA
[2011-01-20] foo_silk lastfm 1.3      |
[2010-11-05] foo_silk lastfm 1.2      | included in foo_silk 4.0
...
[2010-11-25] foo_silk lastfm SN 1.0   | modified release for Silent Night skin by Arnie77
```
#### Changelog / ToDo ####
```
* TODO
...
[2010-XX-XX] foo_silk lastfm 2.0      | add: settings are now stored in a file
                                      ...
                                      | *add: tabs
                                      | *add: easy access to options
                                      | *add: top albums data
                                      | *add: scrolling through charts/data
                                      | *add: styles
                                      | *add: links to lastfm pages
[2011-01-20] foo_silk lastfm 1.3      | fix: tiny changes
                                      | change: restored the set username/api key menu
[2010-11-05] foo_silk lastfm 1.2      | add: built-in update checker
                                      | add: scrolling through individual charts
                                      | add: minimize option through menu
                                      ...
                                      | change: moved set username/api menu to foo_silk 4 window
...
```
```
[2010-11-25] foo_silk lastfm SN 1.0.b | note: this script is based on foo_silk lastfm 1.2
                                      | *change: layout to fit in Silent Night skin
                                      | *change: colors
                                      | *remove: option to set/reset username/api-key
